    ...
    <div className="max-w-7xl mx-auto w-full animate-fade-in pb-10">
      <div className="mb-8">
        ...
        <p className="text-sm font-bold text-gray-400 mt-1">
          Manage all customer reservations and statuses.
        </p>
      </div>
              ...
              <tr className="bg-gray-50/50 border-b border-gray-100">
                <th className="py-5 px-6">
                  <button
                    ...
                    className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-brand-dark transition-colors"
                  >
                ...
                <th className="py-5 px-6 text-[10px] font-black uppercase tracking-widest text-gray-400 text-right">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody>
              {isLoading ? (
                <tr>
                  <td
                    colSpan={7}
                    className="py-12 text-center text-sm font-bold text-gray-400"
                  >
                    Loading bookings...
                  </td>
                </tr>
                ...
                processedBookings.map((booking: any) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <div className="font-bold text-brand-dark text-sm line-clamp-1">
                    ...
                    <td className="py-4 px-6">
                      <div className="font-black text-brand-green text-sm">
      ...
      <Modal
        ...
        onConfirm={() => {
          if (actionModal.bookingId)
            statusMutation.mutate({
              ...
              status:
                actionModal.type === "confirm" ? "confirmed" : "cancelled",
            });
        }}
        title={
          actionModal.type === "confirm" ? "Confirm Booking" : "Cancel Booking"
        }
        message={
        ...
        confirmText={
          actionModal.type === "confirm" ? "Yes, Confirm" : "Yes, Cancel"
        }
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-sm font-bold text-brand-dark truncate">
                  {viewModal.booking.customer_name ||
                    `User ID: ${viewModal.booking.customer}`}
                </p>
              </div>
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p
                  ...
                  title={viewModal.booking.property_title}
                >
                  {viewModal.booking.property_title ||
                    `Prop ID: ${viewModal.booking.property}`}
                </p>
              </div>
              <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-sm font-bold text-brand-dark truncate">
                  {viewModal.booking.guests}{" "}
                  {viewModal.booking.guests === 1 ? "Person" : "People"}
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-black text-brand-dark">
                    {viewModal.booking.check_in}
                  </p>
                </div>
              </div>
              <div className="w-px h-8 bg-brand-green/20"></div>
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-brand-green text-right">
                  Check-out
                </p>
                <p className="text-sm font-black text-brand-dark text-right">
                  {viewModal.booking.check_out}
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-gray-100 flex justify-between items-center">
              ...
              <span className="text-2xl font-black text-brand-green">
                ${Number(viewModal.booking.total_price).toLocaleString()}
              </span>
            </div>
                    ...
                    setTimeout(
                      () =>
                        setActionModal({
                          isOpen: true,
                          type: "cancel",
                          bookingId: viewModal.booking.id,
                        }),
                      200,
                    );
                  }}
