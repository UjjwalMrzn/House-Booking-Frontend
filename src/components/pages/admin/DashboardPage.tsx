...
const DashboardPage = () => {
  ...
  return (
    /* Standardized Width Wrapper (No white box) */
    <div className="max-w-7xl mx-auto w-full animate-fade-in pb-10 px-2 md:px-0">
      
      {/* Standardized Header (Matches AdminPageContainer perfectly) */}
      <div className="mb-8 flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6 px-2 md:px-0">
        <div>
          ...
          <p className="text-sm font-bold text-gray-400 mt-1">Welcome back. Here's today's activity.</p>
        </div>
